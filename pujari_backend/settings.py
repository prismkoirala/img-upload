"""
Django settings for pujari_backend project.
...
SECRET_KEY = "django-insecure-l6$sh4q4@f4z8j%&(lzmm-cg$gz=j&5nb45)y_yps1y6y)tj#^"
...
ROOT_URLCONF = "pujari_backend.urls"
...
WSGI_APPLICATION = "pujari_backend.wsgi.application"
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'core.authentication.ClientAuthentication',
    ],
}
